...
export function Certificates(){
 ...
 <div className="page-title editorial-title"><div><p className="eyebrow">DOCUMENTOS DE LA EMPRESA</p><h1>Certificado</h1><p>Redacta tu documento y revisa la vista previa antes de imprimir.</p></div><Button disabled={!text.trim()} onClick={()=>window.print()}><Printer/>Imprimir / PDF</Button></div>
