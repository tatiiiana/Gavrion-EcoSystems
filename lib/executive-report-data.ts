...
export function executiveSections(report:ReturnType<typeof buildReport>,currency:'LPS'|'USD',unit:'lb'|'ton',rate:number):ExecutiveSection[]{
 ...
 metrics:[{label:'Peso vendido',value:w(s.sold),unit:weightUnit},{label:'Ventas sin ISV',value:m(s.saleTotal),unit:currency},{label:'Total valorizado',value:m(report.billed),unit:currency}],
 chart:series('saleTotal',true,'#2687f3'),
 headers:['Categoría','Tipo de residuo','Peso vendido ('+weightUnit+')','Ventas sin ISV ('+currency+')','Total valorizado ('+currency+')'],
